 ...
 * so rules never depend on the event shape — it can grow (heading, gear...) as
 * more rules need more context.
 */
export interface VehicleSnapshot {
  /** Signed speed in km/h: positive forward, negative in reverse. */
  speedKmh: number;
  /** Position on the ground plane, used to resolve the active speed zone. */
